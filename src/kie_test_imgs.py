...
def test(model, data_loader, draw_edge=False, show=False, out_dir=None):
    model.eval()
    results = []
...
def parse_args():
    ...
    parser.add_argument(
        '--draw_edge', default=True, help='Whether to draw pred edges')
...
def main():
    ...
    test(model, data_loader, args.draw_edge, args.show, args.show_dir)
